 ...
 * from https://github.com/laobie/StatusBarUtil
 * 鉴于透明状态栏在不同的机型上表现不一样。顾将此代码集成到项目中
 * <p>
...
public class StatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.lb_statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.lb_statusbarutil_translucent_view;
