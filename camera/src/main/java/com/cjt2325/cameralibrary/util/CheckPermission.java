...
public class CheckPermission {
    ...
    public static CheckPermission getInstanct(){
    ...
    public void installAudioRecord(){
        int minBuffer = AudioRecord.getMinBufferSize(44100, AudioFormat.CHANNEL_IN_MONO, AudioFormat
                .ENCODING_PCM_16BIT);
        audioRecord = new AudioRecord(MediaRecorder.AudioSource.MIC, 44100, AudioFormat
                .CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, minBuffer);
        point =  new short[minBuffer];
    }
